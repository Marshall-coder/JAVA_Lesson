...
public class TestMain {
    public static void main(String[] args){
       //创建考试机
       ExamMachine machine=new ExamMachine();//调用构造方法时,执行了块
        ...
        if(result.equals("登录成功")){
            ...
            ArrayList<Question> paper =machine.getPaper();//登录成功后抽取试题
...
//
//        String answer="A";//表示题目的答案
//        //面向对象的编程思想---- 把一道题目当做一个对象? title属性 answer属性
